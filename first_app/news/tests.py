...
class NewsTest(TestCase):
    def setUp(self):
        ...
        registered_user = User(username='registered', email='register@register.com')
    ...
    def test_all_urls(self):
        ...
        response_index = self.client.get(url_detail)
        self.assertTemplateUsed(response_index, 'news/detail.html')
